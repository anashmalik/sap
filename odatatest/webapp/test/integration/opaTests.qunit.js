...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "odata/test/odatatest/test/integration/FirstJourney",
    "odata/test/odatatest/test/integration/ZI_021ListJourney",
    "odata/test/odatatest/test/integration/ZI_021ObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
