...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheEmployeesList.onFilterBar().iCheckFilterField("empId");
            Then.onTheEmployeesList.onFilterBar().iCheckFilterField("empName");
            Then.onTheEmployeesList.onFilterBar().iCheckFilterField("empDept");
            Then.onTheEmployeesList.onFilterBar().iCheckFilterField("empRole");
        });

        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheEmployeesList.onTable().iCheckColumns(undefined, {"empId":{"header":"Employee ID"},"empName":{"header":"First Name"},"empSurname":{"header":"Last Name"},"empDept":{"header":"Department"},"empSalary":{"header":"Salary"},"empLocation":{"header":"Location"},"empRole":{"header":"Role"}});
