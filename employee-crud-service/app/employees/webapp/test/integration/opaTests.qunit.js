...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "emp/employees/test/integration/FirstJourney",
    "emp/employees/test/integration/EmployeesListJourney",
    "emp/employees/test/integration/EmployeesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
