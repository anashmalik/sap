...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "demo/list/list/test/integration/FirstJourney",
    "demo/list/list/test/integration/SalesOrdersListJourney",
    "demo/list/list/test/integration/SalesOrdersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
