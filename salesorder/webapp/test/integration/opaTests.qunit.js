...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "sales/salesorder/test/integration/FirstJourney",
    "sales/salesorder/test/integration/SalesOrdersListJourney",
    "sales/salesorder/test/integration/SalesOrdersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
