...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check filter bar", function (Given, When, Then) {
            Then.onTheSalesOrdersList.onFilterBar().iCheckFilterField("SalesOrderNo");
        ...
        opaTest("Check table columns and actions", function (Given, When, Then) {
            Then.onTheSalesOrdersList.onTable().iCheckColumns(undefined, {"SalesOrderNo":{"header":"Sales Order"},"CustomerName":{"header":"Customer Name"},"Amount":{"header":"Amount"},"Currency":{"header":"Currency"},"Status":{"header":"Status"}});
